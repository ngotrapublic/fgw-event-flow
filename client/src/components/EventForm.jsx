    ...
    useEffect(() => {
        if (id) {
            const fetchEvent = async () => {
                try {
                    // Use the single event endpoint directly
                    ...
                    if (event) {
                        ...
                        // For multi-day series events, seriesEndDate is the stored end date field
                        // Populate eventEndDate from it so the form End Date field isn't empty
                        if (!event.eventEndDate && event.seriesEndDate) {
                            event.eventEndDate = event.seriesEndDate;
                        }
                        reset(event);
                    } else {
