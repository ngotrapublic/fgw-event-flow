 ...
 * @param {String} [excludeGroupId] - GroupId to skip entirely — avoids series siblings flagging as conflicts.
 * @returns {Promise<Object|null>} The first conflicting event detected, or null if safe.
 */
exports.checkConflict = async (newEvent, excludeId = null, excludeGroupId = null) => {
    try {
        ...
        const snapshot = await eventsCollection
            ...
            .limit(500) // Raised from 100 to 500 to reduce missed conflicts
            .get();
        ...
        for (const doc of snapshot.docs) {
            ...
            // Protection: Avoid series siblings flagging each other as conflicts
            if (excludeGroupId && event.groupId && event.groupId === excludeGroupId) continue;
